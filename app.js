...
const DAY_INFO = {
  upper: { label: "상체", duration: 80, calories: 705, color: "#F5C518" },
  lower: { label: "하체/등", duration: 72, calories: 640, color: "#3E8FB0" },
  rest: { label: "코어 · 가벼운 유산소", duration: 33, calories: 200, color: "#545C6B" },
};

const EXERCISES = {
  upper: [
    { id: "bench", name: "바벨 벤치프레스", unit: "kg", tip: "어깨뼈를 뒤로 모으고 살짝 젖힌 상태로 허리를 들고, 바를 명치 위쪽에 터치하듯 내렸다가 밀어올림. 팔꿈치는 몸통에서 45도 정도, 손목은 일직선. 겨드랑이로 미는 느낌으로 천천히 일정한 속도로!", sets: [
      { value: 40, reps: 12, rest: 90 }, { value: 50, reps: 12, rest: 90 }, { value: 60, reps: 12, rest: 90 }, { value: 70, reps: 5, rest: 90 } ] },
    { id: "decline", name: "디클라인 덤벨프레스", unit: "kg", tip: "벤치를 뒤로 살짝 기울여 발을 고정하고, 덤벨을 가슴 하부 쪽으로 내렸다가 밀어올리세요. 인클라인보다 가동범위가 짧으니 반동 없이 끝까지 컨트롤하며 천천히!", sets: [
      { value: 12, reps: 12, rest: 90 }, { value: 12, reps: 12, rest: 90 }, { value: 14, reps: 12, rest: 90 }, { value: 14, reps: 12, rest: 90 } ] },
    { id: "incline", name: "인클라인 덤벨프레스", unit: "kg", tip: "벤치 각도는 30도. 쇄골뼈 위쪽에 위치, 덤벨을 가슴 위쪽으로 내렸다가 밀어올리고 덤벨 간격 유지!", sets: [
      { value: 10, reps: 12, rest: 90 }, { value: 12, reps: 12, rest: 90 }, { value: 14, reps: 12, rest: 90 }, { value: 14, reps: 12, rest: 90 } ] },
    { id: "flye", name: "덤벨 플라이", unit: "kg", tip: "팔꿈치를 살짝 굽힌 채 고정하고, 양팔을 아치 모양으로 벌렸다가 가슴 앞에서 모으세요. 팔이 아니라 가슴으로 짜낸다는 느낌으로, 무게보다 가동범위와 스트레칭 느낌이 우선!", sets: [
      { value: 8, reps: 12, rest: 45 }, { value: 10, reps: 12, rest: 45 }, { value: 12, reps: 10, rest: 45 } ] },
    { id: "ohp", name: "덤벨 오버헤드프레스", unit: "kg", tip: "코어에 힘을 주고 허리가 젖혀지지 않게 유지. 덤벨을 귀 옆에서 시작해 머리 위로. 팔을 완전히 펼 때 덤벨이 살짝 안쪽으로 모이는 궤적으로!", sets: [
      { value: 8, reps: 12, rest: 45 }, { value: 8, reps: 12, rest: 45 }, { value: 8, reps: 12, rest: 45 } ] },
    { id: "lateral", name: "레터럴레이즈", unit: "kg", tip: "팔꿈치를 아주 살짝 굽힌 채로 어깨 관절을 축으로 옆으로 들어올림. 어깨 높이보다 높이 들지 말고, 손이 아니라 팔꿈치가 먼저 올라간다는 느낌으로!", sets: [
      { value: 6, reps: 12, rest: 45 }, { value: 6, reps: 12, rest: 45 }, { value: 6, reps: 12, rest: 45 } ] },
    { id: "reardelt", name: "리어델트플라이", unit: "kg", tip: "상체를 앞으로 90도 숙이고 엄지가 안쪽으로 가도록 들고, 팔을 옆으로 벌리며 견갑골을 조인다는 느낌으로 반동 없이 천천히!", sets: [
      { value: 5, reps: 12, rest: 45 }, { value: 5, reps: 12, rest: 45 }, { value: 5, reps: 12, rest: 45 } ] },
    { id: "bicep", name: "덤벨 이두컬", unit: "kg", tip: "팔꿈치를 몸통에 고정하고 팔뚝만. 몸을 뒤로 젖히며 반동 주는 걸 피하고, 내릴 때도 천천히 저항을 느끼면서. 두팔 5·각팔 5·두팔 5 루틴으로!", sets: [
      { value: 6, reps: 15, rest: 45 }, { value: 6, reps: 15, rest: 45 }, { value: 6, reps: 15, rest: 45 } ] },
    { id: "tricep", name: "덤벨 삼두", unit: "kg", tip: "팔꿈치가 벌어지지 않게 고정하고 팔뚝만 굽혔다 폄. 원이 아닌 상하 직선 운동으로!", sets: [
      { value: 14, reps: 12, rest: 45 }, { value: 14, reps: 12, rest: 45 }, { value: 14, reps: 12, rest: 45 } ] },
    { id: "forearm", name: "전완근 (리스트컬 ↔ 리버스 바벨바)", unit: "kg", tip: "팔뚝을 무릎이나 벤치에 고정하고 손목만. 가동범위를 크게 가져가기보다 천천히 쥐어짜는 느낌이 효과적!", sets: [
    ...
    { id: "plank1", name: "플랭크", unit: "sec", defaultWorkSec: 40, tip: "팔꿈치를 어깨 바로 아래 두고, 엉덩이가 뜨거나 처지지 않게 몸을 일직선으로. 허리가 내려가지 않게 배에 힘을 주고 호흡은 편하게!", sets: [
    ...
    { id: "cablecrunch1", name: "케이블 크런치", unit: "kg", tip: "무릎을 꿇고 케이블 로프를 잡은 뒤, 허리가 아니라 복부의 힘으로 상체를 둥글게 말아 내리세요. 엉덩이는 고정하고 팔로 당기지 않도록!", sets: [
      { value: 50, reps: 20, rest: 45 }, { value: 55, reps: 20, rest: 45 }, { value: 60, reps: 20, rest: 0 } ] },
  ],
  lower: [
    { id: "legpress", name: "레그프레스", unit: "kg", tip: "발은 어깨너비로 발판 중앙에, 무릎이 발끝 방향과 같은 각도로 굽히고, 무릎을 완전히 펼 때 락아웃하지 않고 살짝 여유를 남기는 게 관절에 안전!", sets: [
      { value: 50, reps: 12, rest: 90 }, { value: 50, reps: 12, rest: 90 }, { value: 50, reps: 12, rest: 90 } ] },
    { id: "rdl", name: "루마니안 데드리프트", unit: "kg", tip: "무릎은 살짝만 굽히고, 허리를 곧게 편 채로 엉덩이를 뒤로 빼면서 바를 정강이 앞쪽으로 수직으로 쓸고 내려가세요. 햄스트링이 당기면 멈추고 엉덩이 힘으로 일어서세요. 등이 말리면 무게를 낮추세요!", sets: [
      { value: 35, reps: 12, rest: 90 }, { value: 35, reps: 12, rest: 90 }, { value: 35, reps: 10, rest: 90 }, { value: 35, reps: 10, rest: 90 } ] },
    { id: "latpull", name: "랫풀다운", unit: "kg", tip: "바를 어깨너비보다 살짝 넓게 잡고, 가슴을 살짝 내밀고 쇄골 방향으로 당기세요. 몸을 뒤로 젖히며 반동 쓰지 말고, 팔이 아니라 등(광배근)으로 당긴다는 느낌!", sets: [
      { value: 35, reps: 12, rest: 90 }, { value: 40, reps: 10, rest: 90 }, { value: 45, reps: 8, rest: 90 } ] },
    { id: "cablerow", name: "케이블 로우", unit: "kg", tip: "허리를 곧게 세우고 앉아서, 손잡이를 배꼽 방향으로 당기며 견갑골을 조이세요. 상체가 뒤로 크게 젖혀지지 않도록 고정하고 광배와 등에 부하를 느끼며!", sets: [
      { value: 30, reps: 12, rest: 90 }, { value: 35, reps: 10, rest: 90 }, { value: 40, reps: 8, rest: 90 } ] },
    { id: "bulgarian", name: "불가리안스쿼트 (다리당)", unit: "bodyweight", tip: "앞무릎이 발끝을 심하게 넘어가지 않게, 상체는 살짝 앞으로 기울여 균형!", sets: [
      { value: null, reps: 10, rest: 45 }, { value: null, reps: 10, rest: 45 }, { value: null, reps: 10, rest: 45 } ] },
    { id: "calfraise", name: "카프레이즈", unit: "kg", tip: "1/3정도 걸치고 발볼로 지지한 채 뒤꿈치를 최대한 높이 들어올렸다가, 내릴 때는 뒤꿈치가 바닥보다 살짝 아래까지 늘어나게 천천히. 반동 없이!", sets: [
      { value: 30, reps: 15, rest: 45 }, { value: 30, reps: 15, rest: 45 }, { value: 30, reps: 15, rest: 45 } ] },
    { id: "plank2", name: "플랭크", unit: "sec", defaultWorkSec: 40, tip: "팔꿈치를 어깨 바로 아래 두고, 엉덩이가 뜨거나 처지지 않게 몸을 일직선으로. 허리가 내려가지 않게 배에 힘을 주고 호흡은 편하게!", sets: [
      { value: 40, reps: null, rest: 40 }, { value: 40, reps: null, rest: 40 }, { value: 40, reps: null, rest: 40 },
      { value: 40, reps: null, rest: 40 }, { value: 40, reps: null, rest: 40 } ] },
    { id: "cablecrunch2", name: "케이블 크런치", unit: "kg", tip: "무릎을 꿇고 케이블 로프를 잡은 뒤, 허리가 아니라 복부의 힘으로 상체를 둥글게 말아 내리세요. 엉덩이는 고정하고 팔로 당기지 않도록!", sets: [
      { value: 50, reps: 20, rest: 45 }, { value: 55, reps: 20, rest: 45 }, { value: 60, reps: 20, rest: 0 } ] },
  ],
  rest: [
    { id: "plank3", name: "플랭크", unit: "sec", defaultWorkSec: 40, tip: "팔꿈치를 어깨 바로 아래 두고, 엉덩이가 뜨거나 처지지 않게 몸을 일직선으로. 허리가 내려가지 않게 배에 힘을 주고 호흡은 편하게!", sets: [
      { value: 40, reps: null, rest: 40 }, { value: 40, reps: null, rest: 40 }, { value: 40, reps: null, rest: 40 },
      { value: 40, reps: null, rest: 40 }, { value: 40, reps: null, rest: 40 } ] },
    { id: "cablecrunch3", name: "케이블 크런치", unit: "kg", tip: "무릎을 꿇고 케이블 로프를 잡은 뒤, 허리가 아니라 복부의 힘으로 상체를 둥글게 말아 내리세요. 엉덩이는 고정하고 팔로 당기지 않도록!", sets: [
      { value: 50, reps: 20, rest: 45 }, { value: 55, reps: 20, rest: 45 }, { value: 60, reps: 20, rest: 0 } ] },
  ],
};
...
const DEFAULT_UNSELECTED = ["lateral", "reardelt", "forearm"];
...
function announceSet(ex, setIdx) {
  ...
  let detail;
  if (ex.unit === "kg") {
    detail = `${set.value}킬로 ${set.reps}회`;
  } else if (ex.unit === "bodyweight") {
    detail = `맨몸 ${set.reps}회`;
  } else {
    detail = `${set.value}초 유지`;
  }
  speak(`${ex.name} ${setNum}세트입니다. ${detail}. 진행하세요.`);
}

function announceRest(seconds, nextLabel) {
  speak(`휴식입니다. ${seconds}초 후 ${nextLabel}.`);
}
...
function exerciseCardHTML(ex, index) {
  ...
  const tipHTML = ex.tip
    ? `<div style="background:#14161A;border:1px solid #262B34;border-radius:8px;padding:8px 10px;margin-bottom:10px;font-size:14px;color:#B8BFC9;line-height:1.5">💡 ${ex.tip}</div>`
    : "";
...
function dayHTML() {
  ...
  const mainExercises = exercises.filter((e) => !e.id.startsWith("plank") && !e.id.startsWith("cablecrunch"));
  const coreExercises = exercises.filter((e) => e.id.startsWith("plank") || e.id.startsWith("cablecrunch"));
...
function timerBarHTML() {
  ...
  return `<div class="restBar" id="restBar">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
        <span style="font-size:13px;color:#8A93A3;letter-spacing:1px">${label.toUpperCase()}</span>
...
function handleSetTimerFinish(t) {
  ...
  if (t.kind === "setWork") {
    ...
    if (t.restSec > 0) {
      announceRest(t.restSec, t.nextSetIdx === null ? "다음 운동입니다" : `${t.nextSetIdx + 1}세트입니다`);
...
function attachHandlers() {
  ...
  document.querySelectorAll("[data-blockstart]").forEach((el) => {
    el.onclick = () => {
      ...
      const list =
        kind === "main"
          ? exercises.filter((e) => !e.id.startsWith("plank") && !e.id.startsWith("cablecrunch"))
          : exercises.filter((e) => e.id.startsWith("plank") || e.id.startsWith("cablecrunch"));
      startBlock(list);
    };
  });
